...
if not etf_symbol:
    ...
    st.subheader(f"{etf_symbol}: Recent history and forecast")
    ...
    st.subheader(f"{etf_symbol}: 90 days history of top holdings")
    ...
    st.subheader(f"{etf_symbol}: Bollinger recommendations for holdings")
